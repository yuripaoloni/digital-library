...
data class NoteResponse(val id: Long, val book: Book, val page: Int, val title: String, val description: String, val timestamp: String)

fun Note.toNoteResponse(): NoteResponse {
    return NoteResponse(id, book, page, title, description, timestamp.format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")))
}